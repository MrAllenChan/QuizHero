...
function useUrlRouting(options) {
  ...
  }, [currentOverviewMode, currentExportMode, currentPrintMode]);
  ...
  var navigateToNext = React.useCallback(function () {
    ...
    history.current.push("?".concat(qs));
  }, [countSlideElements, currentSlide, currentSlideElement, numberOfSlides, currentOverviewMode, currentExportMode, currentPrintMode, loop, nextSafeSlide]);
  ...
  var navigateToPrevious = React.useCallback(function () {
    ...
    history.current.push("?".concat(qs));
  }, [animationsWhenGoingBack, countSlideElements, currentSlide, currentSlideElement, numberOfSlides, currentOverviewMode, currentExportMode, loop, previousSafeSlide]);
