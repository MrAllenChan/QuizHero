...
var _CodePane = function _CodePane(_ref) {
  var language = _ref.language,
      code = _ref.code;
  return React.createElement(_index.CodePane, {
    autoFillHeight: true,
    language: language
  }, code);
};
...
var compile = (0, _marksy.default)({
  ...
  elements: _objectSpread({}, _mdxComponentMapper.default, {
    codeblock: _CodePane,
    code: _CodePane
  })
});
...
var Markdown = function Markdown(props) {
  return React.createElement(React.Fragment, null, compile((0, _indentNormalizer.default)(props.children)).tree);
};

Markdown.propTypes = {
  children: _propTypes.default.string.isRequired,
  containsSlides: _propTypes.default.bool
};
